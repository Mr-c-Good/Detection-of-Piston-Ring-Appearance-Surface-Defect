...
MFC测试.h
    这是应用程序的主头文件。
    其中包括其他项目特定的标头（包括 Resource.h），并声明 CMFC测试App 应用程序类。

MFC测试.cpp
    这是包含应用程序类 CMFC测试App 的主应用程序源文件。
...
MFC测试Dlg.h、MFC测试Dlg.cpp - 对话框
    这些文件包含 CMFC测试Dlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 MFC测试.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
